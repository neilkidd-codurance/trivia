...
namespace Trivia.Tests
{
    ...
    {
        [TestCase(123, OutputFromSeed123)]
        [TestCase(98765, OutputFromSeed98765)]
        public void WriteGoldenMasterResults(int randomSeed, string expectedResult)
        {
            ...
            using (var stringWriter = new StringWriter())
            {
                ...
                GameRunner.RunGame(new Random(randomSeed));
        ...
        private const string OutputFromSeed123 = @"Chet was added
...
";
        ...
        private const string OutputFromSeed98765 = @"Chet was added
They are player number 1
Pat was added
They are player number 2
Sue was added
